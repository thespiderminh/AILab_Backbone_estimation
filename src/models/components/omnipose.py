...
# from src.models.components.wasp import WASPv2
from wasp import build_wasp
from wasp import WASPv2
...
@hydra.main(version_base="1.3", config_path="../../../configs/model", config_name="lsp")
def main(cfg: DictConfig) -> Optional[float]:
    cfg: LightningDataModule = hydra.utils.instantiate(config=cfg.net.OMNIPOSE)

    model = OmniPose(cfg)
    input = torch.zeros((32, 3, 128, 128))
    print(input.shape)
    output = model(input)
    print(output.shape)
